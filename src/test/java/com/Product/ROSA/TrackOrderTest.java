...
public class TrackOrderTest extends BaseClass {
	...
	@Test
	public void trackOrderTest() throws InterruptedException, IOException {
...
//		driver.findElement(By.xpath("//table[@class='table table-bordered']/tbody/tr[last()]/td[last()]")).click();
		// Switching window control to track and fect order number
//		wLib.switchToWindow(driver, "Order Tracking Details");
